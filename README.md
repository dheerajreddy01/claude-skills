...
[![Skills](https://img.shields.io/badge/skills-40-blue)](./README.md)
...
| **enterprise-devtools/** | jira, splunk, new-relic, datadog, grafana-prometheus, pagerduty, docker, kubernetes | Developer & ops tooling |
...
│   └── marketplace.json         # Lists all 40 skills as standalone plugins
...
├── enterprise-devtools/         # Developer & ops tooling (8 skills)
